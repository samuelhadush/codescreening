        ...
        <div
            ...
            <div class=" p-10 relative w-full h-full  bg-collection-gradient ">
                <div class="flex flex-col items-start justify-center h-full text-white ">
                    ...
                    <p class="font-light font-sans">Includes Guardians of the Galaxy, Guardians of the Galaxy Vol. 2,
                        and
                        Guardians of the Galaxy Vol. 3</p>

                    <button class=" hover:bg-black uppercase rounded-full mt-5 px-6 py-2 font-semibold text-white"><a
                            href="/collection/284433-guardians-of-the-galaxy-collection">View the
                            Collection</a></button>
